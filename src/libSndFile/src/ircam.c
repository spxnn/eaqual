...
{	unsigned int	encoding, subformat ;
	...
	switch (encoding)
	{	case  IRCAM_ULAW :		/* 8-bit Ulaw encoding. */
				error = ulaw_write_init (psf) ;
				break ;
	
		case  IRCAM_ALAW :		/* 8-bit Alaw encoding. */
				error = alaw_write_init (psf) ;
				break ;
